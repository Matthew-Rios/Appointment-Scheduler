...
The appointment scheduler application was made for the fictitious scenario below. It allows users to create an account and login to the application. The application was built to meet the below specfications with a few minor edits.
